            ...
            elms = <div className="wrapper">
                    ...
                    <div id="left" ref="left">
                      ...
                      <div className="left-bot">
                        {/* Gioithieu */}
                        <div className="left-bot-content" style={{visibility: "hidden"}}>
                          <div className="title">
                        ...
                        {/* OBJECTIVE */}
                        <div className="left-bot-objective" style={{visibility: "hidden"}}>
                          <p>OBJECTIVE</p>
                    ...
                    <div id="right" ref="right">
                      ...
                      <div className="right-experience">
                        ...
                        <div className="right-references">
                          ...
                          <div className="cc-left">
                            <div className="subtitle">
                              <p>- Participated in Front-end internship at VEXERE Company.</p>
